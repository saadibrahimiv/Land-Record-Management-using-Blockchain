 App = {
  ...
  if (typeof web3 !== 'undefined') {
    ...
    //App.web3Provider = new Web3.providers.HttpProvider('https://rinkeby.infura.io/v3/db3b8614d72b4492a5689acbe44cf3ad');
    //Web3j web3 = Web3j.build(new HttpService("https://rinkeby.infura.io/v3/db3b8614d72b4492a5689acbe44cf3ad"));
...
App.contracts.asset =  web3.eth.contract(abi).at('0x6aDca35c5C9Ff7e7242b8a5240d8d2aD6A445429');
...
bindEvents: function() {
  ...
  createProperty: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
      ...
      App.contracts.asset.createProperty(PropId, PropVal, PropOwner );
  ...
  approveProperty: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
                    ...
                    console.log(error);
                        ...
                        App.contracts.asset.approveProperty(PropId);});
